        ...
        <ul style="list-style-type:none; color:#000; padding-right:30px;"> <span class="field-content">
                ...
                <li>
                    <article class="entry-item row clearfix">
                        ...
                        <div class="entry-content col-md-9 col-sm-9 col-xs-12">
                            <header>
                                <h2 class="entry-title" style="padding-bottom:3px"><a href="/assistant-professor-ts-raenu-al-kolandaisamy-phd">Assistant Professor Ts Raenu A/L Kolandaisamy, PhD</a></h2>
                ...
                <li>
                    <article class="entry-item row clearfix">
                        ...
                        <div class="entry-content col-md-9 col-sm-9 col-xs-12">
                            <header>
                                <h2 class="entry-title" style="padding-bottom:3px"><a href="/professor-ts-ghassan-saleh-hussein-al-dharhani-phd">Professor Ts Ghassan Saleh Hussein Al-Dharhani, PhD</a></h2>
